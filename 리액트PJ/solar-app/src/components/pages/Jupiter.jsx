        ...
        <section className="jupiter jupiter1">
          ...
          <div className="jupiter1-text">
            ...
            <p className="main-txt">
              ...
              directions. Jupiter’s iconic Great Red Spot is a giant storm
          ...
          <div className="desc desc1 cont-txt">
            ...
            <div className="desc1-text">
              <p>
                ...
                characterize this planet are most likely too extreme and
                volatile for organisms to adapt to.
                <br />
                <br />
                While planet Jupiter is an unlikely place for living things to
                take hold, the same is not true of some of its many moons.
                Europa is one of the likeliest places to find life elsewhere in
                our solar system. There is evidence of a vast ocean just beneath
                its icy crust, where life could possibly be supported.
              </p>
            </div>
          </div>
          {/* <!-- 2-2.설명 두번째 --> */}
          <div className="desc desc2 cont-txt">
            ...
            <div className="desc2-text">
              <p>
                ...
                11 times wider than Earth. If Earth were the size of a grape,
                ...
                Sun. One astronomical unit (abbreviated as AU), is the distance
                from the Sun to Earth. From this distance, it takes sunlight 43
          ...
          <div className="jupiter3-cont">
            <div className="jupiter3-text cont-txt">
              ...
              <p>
                ...
                deep inside the planet crush, melt, and vaporize spacecraft
            ...
            <div className="moon3 moon">
              ...
              >
                ...
                <div className="moon3-text M-text">
                  ...
                  <p className="cont-txt">
                    Io is Jupiter's third largest moon, and the most
                    volcanically active world in our solar system.
                  </p>
                </div>
              </a>
            </div>
            ...
            <div className="jupit5-gbox">
              ...
              <div className="jupit5-box">
                ...
                <div className="jupit5-text cont-txt">
                  ...
                  <p>
                    Jupiter's day lasts only 10 Earth hours; its year is 12
                    Earth years.
                  </p>
                </div>
              </div>
              ...
              <div className="jupit5-box">
                ...
                <div className="jupit5-text cont-txt">
                  <h3>Super Storm</h3>
                  <p>
                    The Great Red Spot is a storm that has raged for more than
                    100 years.
                  </p>
                </div>
              </div>
